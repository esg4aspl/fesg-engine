...
public class Scenario36
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-15-36-13");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"addressbook_sign");
