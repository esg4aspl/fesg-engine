...
public class Scenario26
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-20-26-08");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"encrypt");
