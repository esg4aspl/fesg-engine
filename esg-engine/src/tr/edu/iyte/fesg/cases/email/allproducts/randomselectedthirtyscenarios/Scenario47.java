...
public class Scenario47
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-19-47-18");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"autoresponder_forward_sign");
		...
		FeaturedESG product1 = new FeaturedESG("addressbook_autoresponder_forward_sign",coreESGNameOfPL);
		...
		Set<ESG> featureESGSet1 = IncrementalTestSequenceCompositionUtilities.buildNewFeatureESGSet("addressbook");
