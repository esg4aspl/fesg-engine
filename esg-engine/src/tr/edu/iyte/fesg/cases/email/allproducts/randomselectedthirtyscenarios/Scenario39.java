...
public class Scenario39
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-15-39-14");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"autoresponder_sign");
		...
		FeaturedESG product1 = new FeaturedESG("addressbook_autoresponder_sign",coreESGNameOfPL);
