...
public class FaultTableFileReader {
	...
	public static void main(String[] args) throws IOException {
		String faultsTestExecutions = "files/Cases/EmailPL/1RegFiles/_spl_em_3_faulttables-averagetestexecutions-20percent_1234567890";		
		...
		try {
			csvWriter = new FileWriter("files/MXEFiles/EmailPL/table4-em" + ".csv");
		} catch (IOException e) {
