...
public class Scenario34
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-16-34-12");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"sign");
		...
		FeaturedESG product1 = new FeaturedESG("forward_sign",coreESGNameOfPL);
