...
public class Scenario27
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-11-27-09");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"addressbook_encrypt");
