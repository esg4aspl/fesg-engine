...
public class Scenario09
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-03-09-02");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"autoresponder");
		...
		FeaturedESG product1 = new FeaturedESG("addressbook_autoresponder",coreESGNameOfPL);
