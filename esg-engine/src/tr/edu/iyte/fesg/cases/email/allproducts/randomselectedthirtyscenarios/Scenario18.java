...
public class Scenario18
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-16-18-04");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"forward");
