...
public class Scenario48
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-21-48-20");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"encrypt_sign");
		...
		FeaturedESG product1 = new FeaturedESG("addressbook_encrypt_sign",coreESGNameOfPL);
