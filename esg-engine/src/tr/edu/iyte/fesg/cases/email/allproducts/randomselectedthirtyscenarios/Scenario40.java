...
public class Scenario40
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-18-40-14");
		...
		FeaturedESG product1 = new FeaturedESG("autoresponder_forward_sign",coreESGNameOfPL);
		...
		Set<ESG> featureESGSet1 = IncrementalTestSequenceCompositionUtilities.buildNewFeatureESGSet("forward");
