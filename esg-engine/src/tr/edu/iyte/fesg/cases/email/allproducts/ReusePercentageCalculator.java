...
public class ReusePercentageCalculator {
	...
	public static void main(String[] args) throws IOException {
		String PUCFolder = "files/Cases/EmailPL/Results_IncrementalTestSequenceComposition/TestSequences";
		String existingProductFolder = "files/Cases/EmailPL/Results_IncrementalTestSequenceComposition/ExistingProductTestSequences";
		String singleModelFolder = "files/Cases/EmailPL/Results_SingleModel/TestSequences";
		...
		for (int i = 0; i < puclistOfFiles.length; i++) {
			...
			if (puclistOfFiles[i].isFile()) {
				...
				String prefix3 = "em-02-04-INC_length";
			...
			if (smlistOfFiles[i].isFile()) {
				...
				String prefix3 = "em-02-04_length";
		...
		try {
			csvWriter = new FileWriter("files/Cases/EmailPL/reuse" + ".csv");
		} catch (IOException e) {
