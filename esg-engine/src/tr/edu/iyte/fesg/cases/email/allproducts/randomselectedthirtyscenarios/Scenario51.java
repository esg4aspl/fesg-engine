...
public class Scenario51
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-23-51-22");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"autoresponder_encrypt_sign");
		...
		FeaturedESG product1 = new FeaturedESG("addressbook_autoresponder_encrypt_sign",coreESGNameOfPL);
