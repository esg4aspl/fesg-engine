...
public class Scenario21
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-07-21-06");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"autoresponder_forward");
		...
		FeaturedESG product1 = new FeaturedESG("addressbook_autoresponder_forward",coreESGNameOfPL);
