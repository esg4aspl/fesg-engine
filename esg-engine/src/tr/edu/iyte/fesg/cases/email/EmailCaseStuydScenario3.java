...
public class EmailCaseStuydScenario3 extends EmailCaseStudyUtilities {
	/**
	...
	public static void main(String[] args) {
		...
		FeaturedESG product1 = new FeaturedESG("emailProduct-addressbookAutoresponderSign",coreESGNameOfPL);
		...
		Set<ESG> featureESGSet0 = IncrementalTestSequenceCompositionUtilities.buildNewFeatureESGSet("addressbook","autoresponder","sign");
