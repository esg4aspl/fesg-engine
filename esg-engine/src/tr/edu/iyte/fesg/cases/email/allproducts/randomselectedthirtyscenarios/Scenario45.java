...
public class Scenario45
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-18-45-16");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"forward_sign");
