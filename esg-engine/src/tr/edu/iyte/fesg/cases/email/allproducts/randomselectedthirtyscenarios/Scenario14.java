...
public class Scenario14
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-11-14-03");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"addressbook_autoresponder");
		...
		FeaturedESG product1 = new FeaturedESG("addressbook_autoresponder_encrypt",coreESGNameOfPL);
		...
		Set<ESG> featureESGSet1 = IncrementalTestSequenceCompositionUtilities.buildNewFeatureESGSet("encrypt");
