...
public class EmailCaseStuydScenario5 extends EmailCaseStudyUtilities {
	/**
	...
	public static void main(String[] args) {
		...
		FeaturedESG product1 = new FeaturedESG("emailProduct-autoresponderEncrypt",coreESGNameOfPL);
		...
		Set<ESG> featureESGSet0 = IncrementalTestSequenceCompositionUtilities.buildNewFeatureESGSet("autoresponder","keys","encrypt");
