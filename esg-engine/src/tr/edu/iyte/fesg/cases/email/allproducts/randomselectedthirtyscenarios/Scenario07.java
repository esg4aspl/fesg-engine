...
public class Scenario07
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-09-07-01");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"addressbook");
		...
		FeaturedESG product1 = new FeaturedESG("addressbook_encrypt",coreESGNameOfPL);
