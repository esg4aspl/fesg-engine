...
public class Scenario5188 extends StudentAttendanceSystemCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("sas-1246-5188-1194");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				...
				"viewSchedule_SMS_studentAccess_teacherAccess_updateRecord_addNewSchedule_traceAttendanceActivity_deleteClass_fingerprint");
		...
		Set<ESG> featureESGSet1 = IncrementalTestSequenceCompositionUtilities
				.buildNewFeatureESGSet("viewClass");
