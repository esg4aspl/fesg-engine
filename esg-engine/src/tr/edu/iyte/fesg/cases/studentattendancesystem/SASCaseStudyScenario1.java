...
public class SASCaseStudyScenario1 extends StudentAttendanceSystemCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		FeaturedESG product2 = new FeaturedESG("sasProduct-bothUsersBarcodeSMS", coreESGNameOfPL);
		...
		Set<ESG> featureESGSet1 = IncrementalTestSequenceCompositionUtilities.buildNewFeatureESGSet("teacherAccess",
				"updateRecord", "traceAttendanceActivity", "addNewClass", "updateClassDetail", "deleteClass",
				"addNewSchedule", "editSchedule", "assignNewSchedule");
