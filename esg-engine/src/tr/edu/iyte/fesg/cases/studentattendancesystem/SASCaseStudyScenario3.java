...
public class SASCaseStudyScenario3 extends StudentAttendanceSystemCaseStudyUtilities {
	/**
	...
	public static void main(String[] args) {
		...
		FeaturedESG product2 = new FeaturedESG("sasProduct-studentUserBarcodeSMS", coreESGNameOfPL);
		...
		Set<ESG> featureESGSet1 = IncrementalTestSequenceCompositionUtilities
				.buildNewFeatureESGSet("monitorAttendanceStatus");
		edge1.addFeatureESGSet(featureESGSet1);

		FeaturedESG product3 = new FeaturedESG("sasProduct-bothUsersBarcodeSMS", coreESGNameOfPL);
		...
		Set<ESG> featureESGSet3 = IncrementalTestSequenceCompositionUtilities.buildNewFeatureESGSet("teacherAccess",
				"updateRecord", "traceAttendanceActivity", "addNewClass", "updateClassDetail", "deleteClass",
				"addNewSchedule", "editSchedule", "assignNewSchedule", "monitorAttendanceStatus");
