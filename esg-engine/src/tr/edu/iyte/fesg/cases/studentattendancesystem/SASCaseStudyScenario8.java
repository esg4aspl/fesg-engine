...
public class SASCaseStudyScenario8 extends StudentAttendanceSystemCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		FeaturedESG product2 = new FeaturedESG("sasProduct-seniorSubstituteTeacherUserAccessCardEmail", coreESGNameOfPL);
		...
		Set<ESG> featureESGSet1 =  IncrementalTestSequenceCompositionUtilities.buildNewFeatureESGSet("updateClassDetail");
