...
public class Scenario8178 extends StudentAttendanceSystemCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("sas-2279-8178-1967");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				...
				"viewSchedule_email_studentAccess_teacherAccess_updateRecord_addNewClass_updateClassDetail_addNewSchedule_editSchedule_viewRecord_monitorAttendanceStatus_QRCode");
