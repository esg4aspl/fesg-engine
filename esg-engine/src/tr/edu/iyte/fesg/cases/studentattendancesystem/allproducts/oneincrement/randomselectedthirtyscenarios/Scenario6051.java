...
public class Scenario6051 extends StudentAttendanceSystemCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("sas-2307-6051-1423");
		...
		Set<ESG> featureESGSet1 = IncrementalTestSequenceCompositionUtilities
				.buildNewFeatureESGSet("editSchedule");
