...
public class Scenario7119 extends StudentAttendanceSystemCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("sas-2211-7119-1691");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				...
				"viewClass_email_studentAccess_teacherAccess_updateRecord_addNewClass_addNewSchedule_editSchedule_viewRecord_deleteClass_QRCode");
		...
		Set<ESG> featureESGSet1 = IncrementalTestSequenceCompositionUtilities.buildNewFeatureESGSet("viewSchedule");
