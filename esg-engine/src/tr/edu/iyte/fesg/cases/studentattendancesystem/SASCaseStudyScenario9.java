...
public class SASCaseStudyScenario9 extends StudentAttendanceSystemCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		FeaturedESG product2 = new FeaturedESG("sasProduct-deputyHeadTeacherUserAccessCardEmail", coreESGNameOfPL);
		...
		Set<ESG> featureESGSet1 =  IncrementalTestSequenceCompositionUtilities.buildNewFeatureESGSet("addNewSchedule","editSchedule");
