...
public class Scenario4365 extends StudentAttendanceSystemCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("sas-1107-4365-1003");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				...
				"viewClass_viewSchedule_email_studentAccess_teacherAccess_addNewClass_addNewSchedule_viewRecord_QRCode");
		...
		Set<ESG> featureESGSet1 = IncrementalTestSequenceCompositionUtilities
				.buildNewFeatureESGSet("updateClassDetail");
