...
public class SASCaseStudyScenario6 extends StudentAttendanceSystemCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		FeaturedESG product2 = new FeaturedESG("sasProduct-bothUsersQRCodeSMS", coreESGNameOfPL);
