...
public class Scenario62 extends BankAccountCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-22-62-21");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				allPossibleProductsGenerator, "cancelDeposit_cancelWithdraw_dailyLimit_overdraft");
		...
		FeaturedESG product1 = new FeaturedESG("cancelDeposit_interest_cancelWithdraw_dailyLimit_overdraft",
				coreESGNameOfPL);
