...
public class Scenario36 extends BankAccountCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-19-36-10");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				allPossibleProductsGenerator, "interest_cancelWithdraw_dailyLimit");
		...
		FeaturedESG product1 = new FeaturedESG("interest_cancelWithdraw_dailyLimit_overdraft",
				coreESGNameOfPL);
