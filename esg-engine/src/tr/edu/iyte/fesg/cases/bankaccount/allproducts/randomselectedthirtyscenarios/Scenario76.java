...
public class Scenario76 extends BankAccountCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-38-76-29");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				allPossibleProductsGenerator, "cancelDeposit_credit_interest_interestEstimation");
		...
		FeaturedESG product1 = new FeaturedESG("cancelDeposit_credit_interest_cancelWithdraw_interestEstimation",
				coreESGNameOfPL);
