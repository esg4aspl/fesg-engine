...
public class Scenario67
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-26-67-25");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"credit_interest");
		...
		FeaturedESG product1 = new FeaturedESG("credit_interest_interestEstimation",coreESGNameOfPL);
