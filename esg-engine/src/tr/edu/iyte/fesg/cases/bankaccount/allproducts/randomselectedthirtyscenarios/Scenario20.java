...
public class Scenario20
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-09-20-06");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"cancelWithdraw");
		...
		FeaturedESG product1 = new FeaturedESG("cancelWithdraw_dailyLimit",coreESGNameOfPL);
