...
public class FaultTableFileReader {
	...
	public static void main(String[] args) throws IOException {
		String faultsTestExecutions = "files/Cases/BankAccountPL/1RegFiles/_spl_ba_3_faulttables-averagetestexecutions-20percent_1234567890";		
		...
		try {
			csvWriter = new FileWriter("files/MXEFiles/BankAccountPL/table4-ba" + ".csv");
		} catch (IOException e) {
