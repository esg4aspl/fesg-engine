...
public class BankAccountCaseStudyScenario4 extends BankAccountCaseStudyUtilities {
	/**
	...
	public static void main(String[] args) {
		...
		FeaturedESG product1 = new FeaturedESG("bankAccountProduct-creditWithDailyLimit", coreESGNameOfPL);
