...
public class Scenario23
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-08-23-07");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"interest_cancelWithdraw");
		...
		FeaturedESG product1 = new FeaturedESG("interest_cancelWithdraw_interestEstimation",coreESGNameOfPL);
