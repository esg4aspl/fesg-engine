...
public class Scenario50 extends BankAccountCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-21-50-15");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				allPossibleProductsGenerator, "cancelDeposit_cancelWithdraw_dailyLimit");
		...
		FeaturedESG product1 = new FeaturedESG("cancelDeposit_cancelWithdraw_dailyLimit_overdraft",
				coreESGNameOfPL);
