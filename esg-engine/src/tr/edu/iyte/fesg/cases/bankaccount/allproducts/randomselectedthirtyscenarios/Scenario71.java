...
public class Scenario71 extends BankAccountCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-32-71-26");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				allPossibleProductsGenerator, "credit_interest_interestEstimation");
		...
		FeaturedESG product1 = new FeaturedESG("credit_interest_cancelWithdraw_interestEstimation",
				coreESGNameOfPL);
