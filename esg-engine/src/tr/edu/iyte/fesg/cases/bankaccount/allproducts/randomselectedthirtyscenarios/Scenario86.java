...
public class Scenario86 extends BankAccountCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-39-86-33");
		...
		FeaturedESG product1 = new FeaturedESG("cancelDeposit_credit_cancelWithdraw_dailyLimit",
				coreESGNameOfPL);
