...
public class Scenario55 extends BankAccountCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-23-55-17");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				allPossibleProductsGenerator, "cancelDeposit_interest_cancelWithdraw_dailyLimit_interestEstimation");
		...
		FeaturedESG product1 = new FeaturedESG("cancelDeposit_interest_cancelWithdraw_dailyLimit_interestEstimation_overdraft",
				coreESGNameOfPL);
		...
		Set<ESG> featureESGSet1 = IncrementalTestSequenceCompositionUtilities.buildNewFeatureESGSet("overdraft");
