...
public class Scenario89 extends BankAccountCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-41-89-35");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				allPossibleProductsGenerator, "credit_interest_cancelWithdraw_dailyLimit_interestEstimation");
		...
		FeaturedESG product1 = new FeaturedESG("cancelDeposit_credit_interest_cancelWithdraw_dailyLimit_interestEstimation",
				coreESGNameOfPL);
