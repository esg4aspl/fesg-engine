...
public class Scenario04
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-02-04-01");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"interest");
		...
		FeaturedESG product1 = new FeaturedESG("interest_interestEstimation",coreESGNameOfPL);
