...
public class Scenario83 extends BankAccountCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-35-83-32");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				allPossibleProductsGenerator, "credit_interest_cancelWithdraw_interestEstimation");
		...
		FeaturedESG product1 = new FeaturedESG("credit_interest_cancelWithdraw_dailyLimit_interestEstimation",
				coreESGNameOfPL);
		...
		Set<ESG> featureESGSet1 = IncrementalTestSequenceCompositionUtilities.buildNewFeatureESGSet("dailyLimit");
