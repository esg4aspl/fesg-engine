...
public class Scenario31
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-15-31-09");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"cancelWithdraw_dailyLimit");
		...
		FeaturedESG product1 = new FeaturedESG("cancelDeposit_cancelWithdraw_dailyLimit",coreESGNameOfPL);
