...
public class Scenario54 extends BankAccountCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-40-54-16");
		...
		FeaturedESG product1 = new FeaturedESG("cancelDeposit_credit_interest_cancelWithdraw_dailyLimit",
				coreESGNameOfPL);
