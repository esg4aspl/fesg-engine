...
public class Scenario41
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-13-41-12");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"cancelDeposit_cancelWithdraw");
		...
		FeaturedESG product1 = new FeaturedESG("cancelDeposit_interest_cancelWithdraw",coreESGNameOfPL);
