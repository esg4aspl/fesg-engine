...
public class BankAccountGuardConditionApp_Credit extends TestCoverageAnalysingUtilities  {
	...
	public static void main(String[] args) {
		...
		String guardConditionFeatureName = "cancelDeposit";
		...
		String featureModelPath = "files/Cases/BankAccountPL/configs/model.xml";
