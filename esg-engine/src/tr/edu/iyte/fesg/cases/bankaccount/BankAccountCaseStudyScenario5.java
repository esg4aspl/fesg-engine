...
public class BankAccountCaseStudyScenario5 extends BankAccountCaseStudyUtilities {
	/**
	...
	public static void main(String[] args) {
		...
		FeaturedESG product1 = new FeaturedESG("bankAccountProduct-overdraftWithInterest", coreESGNameOfPL);
