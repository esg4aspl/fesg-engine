...
public class Scenario39 extends BankAccountCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-20-39-11");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				allPossibleProductsGenerator, "interest_cancelWithdraw_dailyLimit_interestEstimation");
		...
		FeaturedESG product1 = new FeaturedESG("interest_cancelWithdraw_dailyLimit_interestEstimation_overdraft",
				coreESGNameOfPL);
