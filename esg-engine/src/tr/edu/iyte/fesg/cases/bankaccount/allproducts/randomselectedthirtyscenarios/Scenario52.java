...
public class Scenario52 extends BankAccountCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-17-52-16");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				allPossibleProductsGenerator, "cancelDeposit_interest_cancelWithdraw_dailyLimit");
		...
		FeaturedESG product1 = new FeaturedESG("cancelDeposit_interest_cancelWithdraw_dailyLimit_interestEstimation",
				coreESGNameOfPL);
		...
		Set<ESG> featureESGSet1 = IncrementalTestSequenceCompositionUtilities.buildNewFeatureESGSet("interestEstimation");
