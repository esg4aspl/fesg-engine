...
public class Scenario78
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-33-78-30");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(allPossibleProductsGenerator,"credit_cancelWithdraw");
		...
		FeaturedESG product1 = new FeaturedESG("credit_cancelWithdraw_dailyLimit",coreESGNameOfPL);
