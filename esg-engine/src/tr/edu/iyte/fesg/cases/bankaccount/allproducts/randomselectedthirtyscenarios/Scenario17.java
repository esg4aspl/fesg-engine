...
public class Scenario17 extends BankAccountCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-14-17-05");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				allPossibleProductsGenerator, "cancelDeposit_interest_interestEstimation");
		...
		FeaturedESG product1 = new FeaturedESG("cancelDeposit_interest_cancelWithdraw_interestEstimation",
				coreESGNameOfPL);
