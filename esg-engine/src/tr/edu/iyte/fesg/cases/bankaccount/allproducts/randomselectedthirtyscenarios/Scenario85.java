...
public class Scenario85 extends BankAccountCaseStudyUtilities {
	...
	public static void main(String[] args) {
		...
		existingProductESGName.append("ba-34-85-33");
		...
		FeaturedESG reusableFESG = AllPossibleProductsGeneratorApp.findFeaturedESGByProductName(
				allPossibleProductsGenerator, "credit_cancelWithdraw_dailyLimit");
		...
		FeaturedESG product1 = new FeaturedESG("credit_interest_cancelWithdraw_dailyLimit",
				coreESGNameOfPL);
